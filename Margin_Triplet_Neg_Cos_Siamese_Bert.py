...
#                 print(out_results)
        ...
        torch.save(model.state_dict(), output_dir +"margin1_costriplet_cos_siamese_bs24_lr2e_5_epoch30.pth")
...
#                   'loss': tr_loss/nb_tr_steps
        ...
        output_eval_file = os.path.join(output_dir, "margin1_costriplet_cos_siamese_bs24_lr2e_5_epoch30_eval_results.txt")
        output_raw_score = os.path.join(output_dir, "margin1_costriplet_cos_siamese_bs24_lr2e_5_epoch30_raw_score.csv")
