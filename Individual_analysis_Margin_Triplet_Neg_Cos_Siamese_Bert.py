...
class TripletLoss(torch.nn.Module):
    ...
    """
    def __init__(self, distance_metric=TripletDistanceMetric.COSINE, triplet_margin=2):
...
def train_and_test(data_dir, bert_model="bert-base-uncased", task_name=None,
                   ...
                   train_batch_size=24, eval_batch_size=1, learning_rate=2e-5, num_train_epochs=15,
...
#                 print(out_results)
        ...
        torch.save(model.state_dict(), output_dir +"margin2_costriplet_cos_siamese_bs24_lr2e_5_epoch15.pth")
...
#         eval_examples = processor.get_test_examples(data_dir)
        eval_examples = processor.get_test_from_command(sys.argv[0], sys.argv[1], sys.argv[2], sys.argv[3])
...
#                 writer.write("%s = %s\n" % (key, str(result[key])))      
        ...
        with open(output_raw_score, 'w') as fout:
            ...
            logger.info("undermine_score:%s, support_score:%s, predict_label:%s, gold:%s" %(str(score[0]),str(score[1]),str(pred),str(gold)))
...
#     bert_model = "/var/scratch/syg340/project/cos_siamese_models/319cos/319_cos_camimu_siamese_bert_epoch5.pth"
    bert_model = "/var/scratch/syg340/project/triplet_siamese_models/margin2_costriplet_cos_siamese_bs24_lr2e_5_epoch15.pth"
    data_dir = "/var/scratch/syg340/project/stance_code/Dataset/"
#     data_dir = "/var/scratch/syg340/project/stance_code/Dataset/ibmcs/"
