...
#                   'loss': tr_loss/nb_tr_steps
        ...
        output_eval_file = os.path.join(output_dir,"train_on_per_eval_on_ibmcs_distance_concat_margin1_costriplet_cos_siamese_bs24_lr2e_5_epoch25_eval_results.txt")
        output_raw_score = os.path.join(output_dir,"train_on_per_eval_on_ibmcs_distance_concat_margin1_costriplet_cos_siamese_bs24_lr2e_5_epoch25_raw_score.csv")
