...
#                   'loss': tr_loss/nb_tr_steps
        ...
        output_eval_file = os.path.join(output_dir, "antonym_pers_500_success_gold0_bert_base_bs32_lr2e_5_epoch4_eval_results.txt")
        output_raw_score = os.path.join(output_dir, "antonym_pers_500_success_gold0_bert_base_bs32_lr2e_5_epoch4_raw_score.csv")
