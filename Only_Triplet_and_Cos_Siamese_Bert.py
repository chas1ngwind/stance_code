...
def train_and_test(data_dir, bert_model="bert-base-uncased", task_name=None,
                   ...
                   train_batch_size=24, eval_batch_size=8, learning_rate=2e-5, num_train_epochs=27,
...
#                 print(out_results)
        ...
        torch.save(model.state_dict(), output_dir +"margin1_Only_costriplet_cos_siamese_bs24_lr2e_5_epoch27.pth")
...
#                   'loss': tr_loss/nb_tr_steps
        ...
        output_eval_file = os.path.join(output_dir, "margin1_Only_costriplet_cos_siamese_bs24_lr2e_5_epoch27_eval_results.txt")
        output_raw_score = os.path.join(output_dir, "margin1_Only_costriplet_cos_siamese_bs24_lr2e_5_epoch27_raw_score.csv")
...
#     bert_model = "/var/scratch/syg340/project/cos_siamese_models/319cos/319_cos_camimu_siamese_bert_epoch5.pth"
    bert_model = "/var/scratch/syg340/project/triplet_siamese_models/margin1_Only_costriplet_cos_siamese_bs24_lr2e_5_epoch27.pth"
    data_dir = "/var/scratch/syg340/project/stance_code/Dataset/"
#     data_dir = "/var/scratch/syg340/project/stance_code/Dataset/ibmcs/"
