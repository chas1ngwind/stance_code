...
#         output_eval_file = os.path.join(output_dir, "train_on_per_eval_on_ibmcs_bert_sia_cos_bs24_lr2e_5_epoch25_eval_results.txt")
#         output_raw_score = os.path.join(output_dir, "train_on_per_eval_on_ibmcs_bert_sia_cos_bs24_lr2e_5_epoch25_raw_score.csv")
        
        output_eval_file = os.path.join(output_dir, "train_on_ibmcs_eval_on_ibmcs_bert_sia_cos_bs24_lr2e_5_epoch25_eval_results.txt")
        output_raw_score = os.path.join(output_dir, "train_on_ibmcs_eval_on_ibmcs_bert_sia_cos_bs24_lr2e_5_epoch25_raw_score.csv")
...
#     bert_model = "/var/scratch/syg340/project/cos_siamese_models/siamese/cos_camimu_siamese_bert_epoch5.pth"
    bert_model = "/var/scratch/syg340/project/cos_siamese_models/ibmcs_bert_sia_cos_bs24_lr2e_5_epoch25.pth"
#     bert_model = "/var/scratch/syg340/project/cos_siamese_models/siamese_ibmcs/ibmcs_siamese_bert_epoch5.pth"
#     data_dir = "/var/scratch/syg340/project/stance_code/Dataset"
    data_dir = "/var/scratch/syg340/project/stance_code/Dataset/ibmcs/"

    data_dir_output = "/var/scratch/syg340/project/stance_code/Evaluation/paper_output/"
