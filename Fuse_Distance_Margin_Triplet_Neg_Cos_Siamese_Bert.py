...
class BertForConsistencyCueClassification(BertPreTrainedModel):
    def __init__(self, config, num_labels=2):
        ...
        self.classifier2 = torch.nn.Linear((2*(config.hidden_size*4+1)+2), num_labels)
...
#         final_logits = self.classifier2(concat_output_all)
        ...
        distance_reps = torch.stack([cp_distance, cop_distance],1)
        
        final_concat = torch.cat((concat_output_all, distance_reps),1)
        final_logits = self.classifier2(final_concat)
...
#             outputs = (loss,) + logits_cos 
            ...
            return final_concat_logits, distance_logtis
...
#                 print(out_results)
        ...
        torch.save(model.state_dict(), output_dir +"fuse_distance_concat_margin1_costriplet_cos_siamese_bs24_lr2e_5_epoch15.pth")
...
#                   'loss': tr_loss/nb_tr_steps
        ...
        output_eval_file = os.path.join(output_dir, "fuse_distance_concat_margin1_costriplet_cos_siamese_bs24_lr2e_5_epoch15_eval_results.txt")
        output_raw_score = os.path.join(output_dir, "fuse_distance_concat_margin1_costriplet_cos_siamese_bs24_lr2e_5_epoch15_raw_score.csv")
...
#     bert_model = "/var/scratch/syg340/project/cos_siamese_models/319cos/319_cos_camimu_siamese_bert_epoch5.pth"
    bert_model = "/var/scratch/syg340/project/triplet_siamese_models/fuse_distance_concat_margin1_costriplet_cos_siamese_bs24_lr2e_5_epoch15.pth"
    data_dir = "/var/scratch/syg340/project/stance_code/Dataset/"
#     data_dir = "/var/scratch/syg340/project/stance_code/Dataset/ibmcs/"
