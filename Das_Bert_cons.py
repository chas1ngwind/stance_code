...
#                   'loss': tr_loss/nb_tr_steps
        ...
        output_eval_file = os.path.join(output_dir, "non_reverse_bert_cons_epoch5_eval_results.txt")
        output_raw_score = os.path.join(output_dir, "non_reverse_bert_cons_epoch5_raw_score.csv")
...
#     bert_model = "/var/scratch/syg340/project/cos_siamese_models/319stancy/319_bertcons_epoch5.pth"
    bert_model = "/var/scratch/syg340/project/cos_siamese_models/non_reverse_bertcons_epoch5.pth"
#     bertcons_epoch5.pth
#     data_dir = "/var/scratch/syg340/project/stance_code/Dataset"
    data_dir = "/var/scratch/syg340/project/stance_code/Dataset/"
