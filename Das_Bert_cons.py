...
#                   'loss': tr_loss/nb_tr_steps
        ...
        output_eval_file = os.path.join(output_dir, "antonym_pers_100_succeeded_gold0_stancy_bs32_lr1e_5_eval_results.txt")
        output_raw_score = os.path.join(output_dir, "antonym_pers_100_successed_gold0_stancy_bs32_lr1e_5_raw_score.csv")
...
#     bertcons_epoch5.pth
#     data_dir = "/var/scratch/syg340/project/stance_code/Dataset"
    data_dir = "/var/scratch/syg340/project/stance_code/Dataset/manul_opposite/stancy_100_gold0/succeeded"
