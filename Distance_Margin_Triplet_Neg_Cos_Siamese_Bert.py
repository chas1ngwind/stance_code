...
#                   'loss': tr_loss/nb_tr_steps
        ...
        output_eval_file = os.path.join(output_dir, "dev_distance_concat_margin1_costriplet_cos_siamese_bs24_lr2e_5_epoch15_eval_results.txt")
        output_raw_score = os.path.join(output_dir, "dev_distance_concat_margin1_costriplet_cos_siamese_bs24_lr2e_5_epoch15_raw_score.csv")
