...
#                   'loss': tr_loss/nb_tr_steps
        ...
        output_eval_file = os.path.join(output_dir, "elim_ori_bert_base_eval_results.txt")
        output_raw_score = os.path.join(output_dir, "elim_ori_bert_base_raw_score.csv")
...
#     data_dir = "/var/scratch/syg340/project/stance_code/Dataset"
    data_dir = "/var/scratch/syg340/project/stance_code/not_elim/"
